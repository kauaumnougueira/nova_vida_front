...
const NavItem = ({
    ...
    <Link
        to={to}
        className={`flex items-center gap-3 rounded-lg px-4 py-2 font-medium transition-colors duration-150 hover:bg-slate-700 hover:text-white hover:shadow-xl dark:hover:bg-gray-800 dark:hover:text-white ${className}`}
